...
def start_server(firmata, command_handler):
    ...
    try:
        ...
        logging.debug('Starting HTTP Server! IP:%s, PORT:%d' % (SERVER_IP, SERVER_PORT))
        print 'Starting HTTP Server! IP:%s, PORT:%d' % (SERVER_IP, SERVER_PORT)
